				...
				<div class="col-sm-12 col-md-3 col-lg-3 col-xl-3">
					<label>AÒo:
						<select class="form-control">
							<option>Seleccione una opciÛn</option>
						</select>
					</label>
				</div>
				<div class="col-sm-12 col-md-3 col-lg-3 col-xl-3">
			...
			<div class="row"> 
				<div class="col-sm-0 col-md-8 col-lg-10 col-xl-10"></div>
		 		<div class="col-sm-12 col-md-2 col-lg-2 col-xl-2">
		 			...
		 			<a href="javascript:;" id="enviar" class="btn btn-info">Enviar informaci√≥n a validar</a>
		 		
		 			<!-- <button type="button" id="guardarInformacion" class="form-control btn btn-primary">Enviar informaci√≥n a validar</button>	 		 -->	
		 		</div>
		 	<!-- 	<div class="col-sm-12 col-md-2 col-lg-2 col-xl-2">
		 			<button type="button" id="guardarInformacion" class="form-control btn btn-primary">Guardar informaci√≥n</button>	 			
		 		</div> -->
		 	</div> 
			<!-- end buttons -->
		</div>	
