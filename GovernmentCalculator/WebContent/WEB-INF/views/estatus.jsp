	...
	<div id="page-container"
		...
		<div id="content" class="content">
			...
			<h1 class="page-header">
				Visualización de flujo de aprobación 
			</h1>
			<!-- end page-header -->
							...
							<table id="data-table-autofill4"
								...
								<tbody>
									<tr class="odd gradeX">
										...
										<td><button data-target="#modal-message"
												data-toggle="modal" class="form-control btn btn-success">
												<i class="fas fa-lg fa-search-plus"></i> Ver estatus
											</button></td>
									...
									<tr class="even gradeC">
										...
										<td><a href="#modal-message" data-toggle="modal"
											class="form-control btn btn-success"><i
												class="fas fa-lg fa-search-plus"></i> Ver estatus</a></td>
		...
		<div class="modal-dialog">
			<div class="modal-content">
				<div class="modal-header">
					<h4 class="modal-title">Flujo de aprobación</h4>
				...
				<div class="modal-footer">
					...
					<a href="javascript:;" class="btn btn-primary">Aceptar</a>
				</div>
			</div>
		</div>
	</div>
