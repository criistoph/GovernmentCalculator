										...
										$.gritter
												.add({
													...
													before_open : function() {
														if (3 === $(".gritter-item-wrapper").length)
															return !1
													}
												}), !1
							}),
...
//NOTIFICACION PARA GUARDAR DATOS
	$('[data-click="swal-primary"]').click(function(e) {
		e.preventDefault(), swal({
			title : "¿Desea guardar la informaci\u00f3n?",
			text : "Tu informaci\u00f3n pasara por un proceso de validaci\u00f3n",
			icon : "info",
			buttons : {
				cancel : {
					text : "Cancelar",
		...
		e.preventDefault(), swal({
			...
			text : "You will not be able to recover this imaginary file!2",
			icon : "info",
			buttons : {
				cancel : {
					text : "Cancel",
		...
		e.preventDefault(), swal({
			title : "Are you sure?3",
			text : "You will not be able to recover this imaginary file!3",
			icon : "success",
			buttons : {
				cancel : {
					text : "Cancel",
		...
		e.preventDefault(), swal({
			...
			text : "You will not be able to recover this imaginary file!4",
			icon : "warning",
			buttons : {
				cancel : {
					text : "Cancel",
		...
		e.preventDefault(), swal({
			title : "Are you sure?5",
			text : "You will not be able to recover this imaginary file!5",
			icon : "error",
			buttons : {
				cancel : {
					text : "Cancel",
